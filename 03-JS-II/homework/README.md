...
* `for`: Esto hace la funcion de una repeticion, se repite las veces que nosotros programamos.
* `&&`, `||`, `!`: En una condicion podemos agregar varios comparadores, dependiendo si queremos que se cumplan las dos o no utilizamos cada uno.
